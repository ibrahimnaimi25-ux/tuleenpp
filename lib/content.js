...
export const content = {
  ...
  hero: {
    ...
    tagline: 'Blending agency strategy\nwith hands-on content craft —\nbilingual in English & Arabic.',
  ...
  about: {
    ...
    heading: 'Creating marketing experiences that connect brands with people.',
    headingEmphasis: 'connect brands with people',

    // Bio paragraphs
    bio: [
      "I'm Tuleen Rezek, a Marketing & Content Specialist with hands-on experience across agency, freelance, and brand environments. Through internships at Wunderman (MENACOM Group) and Digital Direction, I've contributed to strategy and content for international accounts — including Saudi Arabia's AlUla Royal Commission — and helped plan brand activations such as the Ploom 'Sensoria' launch event in Amman.",
      "Beyond agency work, I've managed social media and marketing for restaurants, beauty salons, and lifestyle brands as a freelancer — growing audiences, building content calendars, and shaping visual identities that connect with people. I bring strategy and creative execution together to help brands build a presence that feels authentic.",
    ],
