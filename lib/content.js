...
export const content = {
  ...
  hero: {
    ...
    headline: [
      { text: 'Digital',    italic: false, gold: false, delay: 0.2 },
      { text: 'Marketing',  italic: true,  gold: false, delay: 0.36 },
      { text: '& Social',   italic: false, gold: false, delay: 0.52 },
      { text: 'Strategy.',  italic: false, gold: true,  delay: 0.68 },
    ],
