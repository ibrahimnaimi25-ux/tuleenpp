export const projects = [
  ...
  },
  {
    ...
    image: '/badelha-screens/screen-7.png',
    gallery: [
      { src: '/badelha-screens/screen-1.png', caption: 'Brand Color Palette & Identity' },
      { src: '/badelha-screens/screen-4.png', caption: 'App Onboarding — Sign Up Screen' },
      { src: '/badelha-screens/screen-7.png', caption: 'Home Dashboard — Points & QR Scan' },
      { src: '/badelha-screens/screen-2.png', caption: 'Drop It Off — Vending Machine Locations' },
      { src: '/badelha-screens/screen-5.png', caption: 'Recycling Success — Points Earned' },
      { src: '/badelha-screens/screen-8.png', caption: 'QR Code Scanner — Vending Machine' },
    ],
    accentColor: '#4CAF7D',
  },
  {
