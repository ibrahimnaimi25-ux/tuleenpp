        ...
        >
          {project.video ? (
            ...
            <div className="absolute inset-0 overflow-hidden">
              {/* Logo fills card — invert(1) makes white→black, hue-rotate(180deg) cycles green+purple back to their original hues */}
              <div className="absolute inset-0 flex items-center justify-center" style={{ padding: '6% 14%' }}>
                <img
                  src={project.image}
                  alt={project.name}
                  className="w-full h-full object-contain"
                  style={{ filter: 'invert(1) hue-rotate(180deg) brightness(0.88) saturate(1.5)' }}
                />
              </div>

              {/* Vignette — keeps card edges dark so title footer reads clean */}
              <div className="absolute inset-0 pointer-events-none" style={{
                background: 'radial-gradient(ellipse at center, transparent 35%, rgba(8,15,10,0.72) 100%)',
              }}/>
